...
fire2010 = read.shape("modis_fire_2010_365_conus", path="~/Downloads/MODISfire2010")
...
load('~/Downloads/bioclim_10m.Rdata')
plot(bioStack, "mat")
...
```
```{r}
spplot(fire2010, 'JULIAN', cex=1/12)
...
m%>% addCircleMarkers(radius= ~firenc$TEMP/max(firenc$TEMP))
```
